...
/* Feldern gegeben. Jedes Feld außer den Randfeldern hat 4 Nachbarfelder.     */
...
%
/******************************************************************************/
/*  4. Welt mit kreuzförmigen Hinterniss                                      */
/*----------------------------------------------------------------------------*/
%  y
%    +---+---+---+---+---+---+---+---+
%  1 | S |   |   |   |   |   |   |   |
...
%
/******************************************************************************/
/* In den Schemata sind mit S bzw. Z Start und Ziel für die Suche angegeben.  */
/******************************************************************************/
/* Die jeweilige Wissensbasis kann durch folgendes Prädikat geladen werden,   */
/* wobei N=Abkürzung des Dateinamens: member(N,[o_h,w_h,s_h,k_h,d_h,l_h,z_h]).*/
/*----------------------------------------------------------------------------*/
...
/******************************************************************************/
/* Aufgabe 1: Bestimmen Sie die Anzahl der Übergänge für die 7 Konfigurationen*/
/*----------------------------------------------------------------------------*/
/* Aufgabe 2: Definieren Sie ein Prädikat für die Tiefensuche tiesu und       */
/*            bestimmen damit für die 8 Konfigurationen jeweils die ersten    */
/*            Lösungen bei einer Suche mit START=k(1,1) und ZIEL=k(8,8).      */
/*            Überzeugen  Sie sich von der Korrektheit des gefunden Wegs und  */
/*            geben dessen Länge an!                                          */
/*----------------------------------------------------------------------------*/
/* Aufgabe 3: Definieren Sie ein Prädikat für die Breitensuche breisu und     */
/*            bestimmen damit die ersten Lösungen für die 7 Konfigurationen   */
/*            bei einer Suche mit START=k(1,1) und ZIEL=k(8,8). Überzeugen    */
/*            Sie sich von der Korrektheit des gefunden Wegs und geben dessen */
/*            Länge an!                                                       */
/*----------------------------------------------------------------------------*/
/* Aufgabe 4: Definieren Sie ein Prädikat für die heuristische Suche          */
/*            hill_climb und bestimmen damit die ersten Lösungen für die      */
/*            7 Konfigurationen bei einer Suche mit START=k(1,1) und          */
/*            ZIEL=k(8,8). Überzeugen Sie sich von der Korrektheit des        */
/*            gefunden Wegs und geben dessen Länge an!                        */
/*            Zur Sortierung der bewerteten Nachbarn können Sie das Prädikat  */
/*            keysort benutzen. Dieses sortiert die Listenelemente einer      */
/*            Liste wenn diese mit einem Sortierschlüssel in Form einer Zahl  */
/*            versehen sind, die mit dem Listenelement mittels "-" verbunden  */
/*            ist.                                                            */
/*            keysort([3-x,5-y,2-z,1-u,4-v,6-w],SL). =>                       */
/*                                    SL=[1-u,2-z,3-x,4-v,5-y,6-w].           */
/*----------------------------------------------------------------------------*/
/* Aufgabe 5: Definieren Sie ein Prädikat manht für eine Suche mit            */
/*            vollständiger Information über die Welt ohne Hindernisse, das   */
/*            auf der Basis der vollständigen Information zielgerichtet den   */
/*            kürzesten Weg bei einer Suche mit START=k(1,1) und ZIEL=k(8,8)  */
/*            bestimmt.                                                       */
/*----------------------------------------------------------------------------*/
/* Aufgabe 6: Stellen Sie die Ergebnisse in einer Liste zusammen              */
/*                                                                            */
/*  Pfadlänge | o_h | w_h | s_h | k_h | d_h | d_h | z_h                       */
/* -----------+-----+-----+-----+-----+-----+-----+-----                      */
/* tiesu      | 57  |     |     |     |     |     |                           */
/* breisu     |     |     |     |     |     |     |                           */
/* hill_climb |     |     |     |     |     |     |                           */
