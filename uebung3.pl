...
pfadz(X,Y,[X|R],P):-kante_zg(X, NEW),not(member(NEW,R)),pfadz(NEW,Y,[NEW|[X|R]],P).
...
%5.1
nb(bayern, thüringen).
nb(bayern, badenwürttemberg).
nb(bayern, sachsen).
nb(bayern, hessen).
nb(badenwürttemberg, hessen).
nb(badenwürttemberg, rheinlandpfalz).
nb(saarland, rheinlandpfalz).
nb(hessen, thüringen).
nb(sachsen, thüringen).
nb(sachsenanhalt, thüringen).
